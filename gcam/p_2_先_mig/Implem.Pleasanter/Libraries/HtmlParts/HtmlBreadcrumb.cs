...
namespace Implem.Pleasanter.Libraries.HtmlParts
{
    public static class HtmlBreadcrumb
    {
        ...
        {
            NameValueCollection queryString = QueryStringParser.Parse(context.Query);
            if (view != null)
            {
            ...
            {
                Query = string.Join("&", queryString.AllKeys.Select(k => k + "=" + WebUtility.UrlEncode(queryString[k])))
             }.ToString();
         }
     }
 }